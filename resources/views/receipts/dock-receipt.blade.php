        ...
        <div class="content-wrapper">
            ...
            <table class="info-table">
                ...
                <tr>
                    ...
                    <td class="info-value">{{ !empty($receipt->eta) ? date('M d, Y', strtotime($receipt->eta)) : 'N/A' }}</td>
                    <td class="info-label">Location Received</td>
                    <td class="info-value">{{ $receipt->location_received ?? 'N/A' }}</td>
                </tr>
            </table>
            ...
            <p style="color: #45464d; line-height: 1.5; margin-bottom: 10px; font-size: 13px;">{{ $receipt->notes }}</p>
            @endif
